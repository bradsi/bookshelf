        ...
        <div class="px-4 py-6 sm:px-6 flex justify-between flex-wrap gap-y-3">
            ...
            <div class="space-y-2">
                <form action="{{ route('wishlist.store', $book->id) }}" method="POST" class="inline-block">
                    @csrf
                    <button type="submit"
                            class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-yellow-600 hover:bg-yellow-500">
                ...
                <form action="{{ route('bookshelf.store', $book->id) }}" method="POST" class="inline-block">
                    @csrf
                    <button type="submit"
